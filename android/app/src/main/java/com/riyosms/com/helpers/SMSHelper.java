package com.riyosms.com.helpers;
...
import com.riyosms.com.dtos.SMSDTO;
import com.riyosms.com.receivers.SMSStatusReceiver;
import com.riyosms.com.workers.SMSStatusUpdateWorker;
...
public class SMSHelper {
    ...
    public static boolean sendSMS(String phoneNo, String message, String smsId, String smsBatchId, Context context) {
        ...
        if (!RiyoSmsUtils.isPermissionGranted(context, Manifest.permission.SEND_SMS)) {
    ...
    public static boolean sendSMSFromSpecificSim(String phoneNo, String message, int simSubscriptionId, 
        ...
        if (!RiyoSmsUtils.isPermissionGranted(context, Manifest.permission.SEND_SMS) ||
            !RiyoSmsUtils.isPermissionGranted(context, Manifest.permission.READ_PHONE_STATE)) {
