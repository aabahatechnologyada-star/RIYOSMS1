...
import com.riyosms.com.dtos.HeartbeatInputDTO;
import com.riyosms.com.dtos.HeartbeatResponseDTO;
...
public class HeartbeatHelper {
    ...
    public static boolean sendHeartbeat(Context context, String deviceId, String apiKey) {
        ...
        try {
            ...
            simInfoCollection.setSims(RiyoSmsUtils.collectSimInfo(context));
