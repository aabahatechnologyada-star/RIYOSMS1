package com.riyosms.com.workers;
...
import com.riyosms.com.helpers.SMSHelper;
...
public class SmsSendWorker extends Worker {
    ...
    private Integer resolveSim(Context context, int backendSimId) {
        ...
        if (backendSimId != -1 && RiyoSmsUtils.isValidSubscriptionId(context, backendSimId)) {
        ...
        if (preferredSim != -1 && RiyoSmsUtils.isValidSubscriptionId(context, preferredSim)) {
