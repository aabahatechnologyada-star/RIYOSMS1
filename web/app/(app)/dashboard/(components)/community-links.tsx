  ...
  const socials = [
    {
      ...
      name: 'Facebook',
      url: 'https://www.facebook.com/sharer/sharer.php?u=https://riyosms.com',
    },
    {
      icon: '/images/x.svg',
      name: 'Twitter',
      url: 'https://twitter.com/intent/tweet?url=https://riyosms.com&text=🚀+Just+discovered+@riyosmsdotdev+-+an+amazing+SMS+gateway+platform!+Perfect+for+those+who+need+reliable+sms+integration.',
    },
    {
      icon: '/images/linkedin2.svg',
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/sharing/share-offsite/?url=https://riyosms.com',
    },
    {
      icon: '/images/reddit.svg',
      name: 'Reddit',
      url: 'https://www.reddit.com/submit?url=https://riyosms.com&title=riyosms.com+-+Developer-friendly+SMS+Gateway+Platform',
    },
    {
      icon: '/images/whatsapp.svg',
      name: 'WhatsApp',
      url: "https://api.whatsapp.com/send?text=Hey!+Check+out+riyosms.com+-+it's+a+fantastic+SMS+gateway+platform+perfect+for+those+who+need+reliable+sms+integration+🚀+https://riyosms.com",
    },
    {
      icon: '/images/telegram.svg',
      name: 'Telegram',
      url: 'https://t.me/share/url?url=https://riyosms.com&text=🔥+Found+an+awesome+SMS+gateway+platform+-+riyosms.com!+Great+for+those+who+need+reliable+sms+integration.',
    },
    {
      icon: '/images/gmail.svg',
      name: 'Email',
      url: "mailto:?subject=Check+out+riyosms.com+-+SMS+Gateway+Platform&body=Hi!%0A%0AI+wanted+to+share+riyosms.com+with+you+-+it's+an+excellent+SMS+gateway+platform+that's+perfect+for+those+who+need+reliable+sms+integration.%0A%0ACheck+it+out:+https://riyosms.com%0A%0ABest+regards!",
    },
  ]
    ...
    <>
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-2'>
        ...
        <Card>
          ...
          <CardContent>
            <p className='text-sm text-muted-foreground mb-4'>
              Help others discover riyosms.com by sharing it with your network.
            </p>
            ...
            >
              <Share2 className='mr-2 h-4 w-4' /> Share riyosms.com
            </Button>
          </CardContent>
        </Card>
      </div>
        ...
        <DialogContent className='sm:max-w-[600px] min-w-[500px] text-base'>
          <DialogHeader>
            <DialogTitle className='text-primary mb-2 text-2xl font-bold'>
              Share riyosms.com with Others
            </DialogTitle>
            <p className='text-muted-foreground'>
              Help us grow by sharing riyosms.com with your friends and
              colleagues!
            </p>
          </DialogHeader>
